    ...
    <div className="admin-card">
      ...
      <div className="search-section">
        <div className="search-inputs">
          <input
            type="text"
            placeholder="Search users by skill or tool..."
            value={searchTerm}
          ...
          >
            ...
            <option value="tool">Search by Tools</option>
          </select>
        </div>
        <button onClick={filterUsers} className="search-button">
          Search
        </button>
        {searchTerm && (
          <button 
      ...
      <div className="search-results-info">
        {searchTerm && (
          <p>Found {filteredUsers.length} users matching "{searchTerm}" in {searchCategory}s</p>
        )}
      </div>
